package com.dinet.organization.organizationprofile;

import com.liferay.util.bridges.mvc.MVCPortlet;
//import com.dinet.organization.organizationprofile.DuplicateEntryEmailAddressException;
//import com.dinet.organization.organizationprofile.EntryEmailAddressException;
//import com.dinet.organization.organizationprofile.model.Entry;
//import com.dinet.organization.organizationprofile.service.EntryLocalServiceUtil;
import com.dinet.organization.util.ContactsConstants;
import com.dinet.organization.util.ContactsUtil;
import com.dinet.organization.util.PortletKeys;
...
/**
 * Portlet implementation class OrganizationProfilePortlet
 * 

     * @see MVCPortlet#MVCPortlet()
  
 */
public class OrganizationProfilePortlet extends MVCPortlet {
    /*       
...
//    		User user = themeDisplay.getUser();
    		...
    		UsersAdminUtil.updateEmailAddresses(
    			Organization.class.getName(), organization.getOrganizationId(), emailAddresses);
    	}
...
//    		User user = themeDisplay.getUser();
    		...
    		UsersAdminUtil.updateAddresses(
    			Organization.class.getName(), organization.getOrganizationId(), addresses);
    	}
    	...
    	protected void updateAsset(ActionRequest actionRequest) throws Exception {
    		...
    		OrganizationLocalServiceUtil.updateAsset(
    			user.getUserId(), organization, assetCategoryIds, assetTagNames);
...
//    		User user = themeDisplay.getUser();
//    		Organization organization = (Organization) actionRequest.getAttribute("ORGANIZATION");
    		...
    		String comments = BeanParamUtil.getString(
        			organization, actionRequest, "comments");
...
*/
    		Organization organization2 = OrganizationLocalServiceUtil.getOrganization (organizationId);
    		
    		organization2.setComments (comments);
    		
    		OrganizationLocalServiceUtil.updateOrganization(organization2);
