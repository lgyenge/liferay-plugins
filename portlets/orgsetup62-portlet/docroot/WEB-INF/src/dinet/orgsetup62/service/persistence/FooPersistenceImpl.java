...
import dinet.orgsetup62.NoSuchFooException;

import dinet.orgsetup62.model.Foo;
import dinet.orgsetup62.model.impl.FooImpl;
import dinet.orgsetup62.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(dinet.orgsetup62.model.Foo foo)
		throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.dinet.orgsetup62.model.Foo")));
