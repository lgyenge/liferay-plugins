...
/**
 * Provides the local service interface for Ceg. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gyengelaszlo
 * @see CegLocalServiceUtil
...
public interface CegLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CegLocalServiceUtil} to access the ceg local service. Add custom service methods to {@link dinet.orgsetup62.service.impl.CegLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
