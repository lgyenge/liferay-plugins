 ...
 * @generated
 */
public abstract class CegActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CegActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CegLocalServiceUtil.getService());
		setClass(Ceg.class);

		setClassLoader(dinet.orgsetup62.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("cegId");
	}
}