...
package dinet.orgsetup62.service.messaging;
...
import dinet.orgsetup62.service.FooServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			CegLocalServiceUtil.clearService();

			FooLocalServiceUtil.clearService();

			FooServiceUtil.clearService();
			OrgLocalServiceUtil.clearService();
