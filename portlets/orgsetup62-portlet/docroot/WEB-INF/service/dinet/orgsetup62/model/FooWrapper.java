...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(dinet.orgsetup62.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<dinet.orgsetup62.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public dinet.orgsetup62.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public dinet.orgsetup62.model.Foo toUnescapedModel() {
