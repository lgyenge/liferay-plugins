...
<%@	page import="com.dinet.organization.model.Entry" %>
--%>

<%-- <%@	page import="com.dinet.organization.service.EntryLocalServiceUtil" %> 
<%@	page import="com.dinet.organization.util.ContactsConstants" %>
<%@	page import="com.dinet.organization.util.OrganizationportletConstants" %>
<%@	page import="com.dinet.organization.util.ContactsExtensionsUtil" %>
<%@	page import="com.dinet.organization.util.ContactsUtil" %>
<%@	page import="com.dinet.organization.util.PortletKeys" %>
<%@	page import="com.dinet.organization.util.SocialRelationConstants" %>
<%@	page import="com.dinet.organization.util.WebKeys" %>
--%>
<%-- 
...
<%@	page import="com.liferay.portal.model.OrganizationModel" %>
